    ...
    <div class="nav">
      ...
      <div class="menu">
        ...
        <ul>
          ...
          <li><i class="fa fa-signal"></i>Find Matatu to your route</li>
...
// Get the view header element
const viewHeader = document.querySelector('.viewHeader');

// Change the view header text
viewHeader.querySelector('.title').textContent = 'Hello there is it';
...
// Add the element to the view header
viewHeader.appendChild(dateTimeElement);
</script>
